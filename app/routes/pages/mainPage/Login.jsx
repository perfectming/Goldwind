        ...
        <FixedContent mode="fullWidth" width={1920}>
          {
            ...
            <form className={css.loginBox}>
              <input placeholder=" 用户名:" className={css.int} id="qq" type="text" name="username"/><br/>
              <input placeholder=" 密码:" className={css.int} type="password" name="password"/><br/>
              <input className={css.submit} type="submit " value='登      陆' readOnly="true" onClick={()=>login(123)}/>
            </form>
          </div>
          }
        </FixedContent>
