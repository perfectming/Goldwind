            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    for (var i in data.data) {
                        ...
                        runtime1.push(data.data[i].costs);   //实际发电量
                        downtime1.push(data.data[i].earning);   //故障损失//维护损失
                        tba1.push(data.data[i].rate.toFixed(3)*100);     //故障损失//维护损失
                ...
                success:function(data){
                   console.log(data)
                    ...
                    for (var i=0;i<10;i++) {
                        ...
                        runtime2.push(data.data[i].costs);   //实际发电量//故障损失
                        downtime2.push(data.data[i].earning); //维护损失
                        tba2.push(data.data[i].rate.toFixed(3)*100); //维护损失
