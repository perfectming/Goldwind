...
let Component = React.createClass({
    ...
    render() {
        ...
        let {w0,changedata1,x,hlyyear,jhpcolor,hlymonth,barLoTime,text,barLoPowerValue,wc1,hhdata,actbt,groupid,ipUrl}=this.props;
        let configPie = {
            chart: {
                height:400,
                ...
                series: {
                    ...
                    events: {
                        click: function(e) {
                            w0=e.point.category;
                            wc1=e.point.index;
                            changedata1(w0,win,wc1,hhdata,actbt,ipUrl,groupid,hlyyear,hlymonth,);
