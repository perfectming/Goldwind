...
import Hly_t from '../group/groupj/Hly_t.jsx';
import Hly_r from '../group/groupj/Hly_r.jsx';
import Hly_rs from '../group/groupj/Hly_rs.jsx';
var $ = require('jquery');
...
let Component = React.createClass({
    ...
    render() {
        ...
        let {w0,w10,mon,ipUrl,win,windplan=win,befor_pages='group',hhdata,namex3,healthy3,namex2,healthy2,namex1,healthy1, returnit,hideit,wind, buttonAction, actbt = 0,  value0, inputOnChange, onFocus, changecolor, gogogo, back, more, arr,arr2} = this.props;
                ...
                <div className={styles.fbox}>
                    ...
                    <div className={`${styles.rbox2} ${styles.box_shadow} ${styles.logofa}`}>
                        ...
                        <div className={styles.rbox4}>
                            ...
                            <div className={styles.logomini1}>
