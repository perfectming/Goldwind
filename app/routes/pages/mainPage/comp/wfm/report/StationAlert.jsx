                                    ...
                                    <div className={styles.selectye} id='selectye'>
                                        {
                                            treetype.map((value, key)=> {
                                                return (
                                                    <div className={styles.item} key={key} onClick={()=>{showType(value.id)}}>{value.name}</div>
                                                )
                                            })
                                        }
                                    </div>
                                    ...
                                    <div className={styles.selectye} id='selectye2'>
                                        {
                                            logType!==undefined && logTypeArr.map((value, key)=> {
                                                return (
                                                    <div className={styles.item} key={key} onClick={()=>{showTypeId(value.id)}}>{value.name}</div>
                                                )
                                            })
                                        }
                                    </div>
