            ...
            <div className={skinStyle==1?styles.bodyBoxBlue:skinStyle==2?styles.bodyBoxWhite:styles.bodyBox}>
                ...
                <div className={`${styles.Situation} ${styles.box_shadow}`}>
                    <div className={styles.hoverBoxD} id="hoverBoxD">
                            <span>年累计发电量<br/>{(data2[8888800].YearEgyAt/10000).toFixed(1)}万kWh</span><br/>
                            <span>年计划发电量<br/>{(data2[8888800].YearPlanTotEgyAt/10000).toFixed(1)}万kWh</span>
                    </div>
                    <div className={styles.hoverBoxM} id="hoverBoxM">
                            <span>月累计发电量<br/>{(data2[8888800].MonthEgyAt/10000).toFixed(1)}万kWh</span><br/>
                            <span>月计划发电量<br/>{(data2[8888800].CurMonthPlanEgyAt/10000).toFixed(1)}万kWh</span>
                    </div>
